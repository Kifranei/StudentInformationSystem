...
系统前端设计灵感来源于真实的校园教务系统，并在此基础上进行了现代化和响应式改造，实现了桌面端和移动端的完美适配。同时，项目加入了人性化的亮色/暗色主题切换功能，提升了用户体验。

## 主要功能

### 👨‍💻 管理员 (Administrator)

- **动态仪表盘**: 实时查看学生、教师、课程、选课人次等核心数据统计。
- **学生管理**: 完整的学生信息增、删、改、查（CRUD）及按姓名/学号搜索功能。
- **教师管理**: 完整的教师信息 CRUD 及按姓名/工号搜索功能。
- **班级管理**: 完整的班级信息（含专业、学年）CRUD 功能。
- **课程管理**: 完整的课程信息 CRUD 及按课程名/教师名搜索功能。
- **考试管理**: 发布、修改、删除所有课程的考试安排。
...
本项目的完成离不开Gemini 2.5 Pro和Github Copilot Pro（Gemini 2.5 Pro）的协助。
